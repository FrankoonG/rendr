...
func TestClassifyProbeErrorErrnoTable(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "EAFNOSUPPORT", errno: syscall.EAFNOSUPPORT, state: FeatureUnsupported, reason: ReasonPrimitiveUnsupported},
		{name: "EPFNOSUPPORT", errno: syscall.EPFNOSUPPORT, state: FeatureUnsupported, reason: ReasonPrimitiveUnsupported},
		{name: "EPROTONOSUPPORT", errno: syscall.EPROTONOSUPPORT, state: FeatureUnsupported, reason: ReasonPrimitiveUnsupported},
		{name: "ESOCKTNOSUPPORT", errno: syscall.ESOCKTNOSUPPORT, state: FeatureUnsupported, reason: ReasonPrimitiveUnsupported},
