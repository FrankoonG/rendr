...
func TestSelectedTiers(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			gotT3, gotT4, gotT5, gotT6, gotT7 := selectedTiers(tt.cfg)
			if gotT3 != tt.wantT3 || gotT4 != tt.wantT4 || gotT5 != tt.wantT5 || gotT6 != tt.wantT6 || gotT7 != tt.wantT7 {
				t.Fatalf("selectedTiers=%v/%v/%v/%v/%v want %v/%v/%v/%v/%v",
					gotT3, gotT4, gotT5, gotT6, gotT7,
