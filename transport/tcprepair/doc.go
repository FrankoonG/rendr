...
// Specifically:
//
//   - No coordination with the iptables migration window. Callers
//     today own the iptables -j DROP rule on the 5-tuple between
//     the snapshot and the restore-exit-repair step. The POC (and
//     this package's tcprepair_test.go) shows the canonical sequence.
